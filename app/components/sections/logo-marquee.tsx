const LOGO_ROW_A = ["/brand/wordmark-teal.png", "/brand/logomark-teal.png"];

const LOGO_ROW_B = ["/brand/wordmark-teal.png", "/brand/logomark-teal.png"];
...
function MarqueeRow({
  ...
  const half = Array.from({ length: 8 }, () => logos).flat();
